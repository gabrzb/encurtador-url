        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 mb-10">
          <div className="flex flex-col gap-4 max-w-xs">
            ...
            <div className="flex items-center gap-2">
              <a
                href="#"
                aria-label={content.footer.socialAriaLabels.linkedin}
              ...
              <a
                href="#"
                aria-label={content.footer.socialAriaLabels.instagram}
                className="social-btn w-9 h-9 rounded-xl flex items-center justify-center"
                style={{ color: 'var(--text-1)' }}
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              ...
              <a
                href="#"
                aria-label={content.footer.socialAriaLabels.facebook}
                className="social-btn w-9 h-9 rounded-xl flex items-center justify-center"
                style={{ color: 'var(--text-1)' }}
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
