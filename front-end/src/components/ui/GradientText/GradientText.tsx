...
export default function GradientText({
  ...
  return (
    <motion.span
      className={`relative inline-block max-w-fit align-baseline transition-shadow duration-500 ${
        showBorder ? 'overflow-hidden rounded-[1.25rem] px-2 py-1 backdrop-blur' : ''
      } ${className}`}
